 ...
 */
public abstract class DRefreshViewHolder {
    /**
     ...
     * 下拉刷新上拉加载更多控件
     */
    protected DPullRefreshLayout mRefreshLayout;
    /**
     * 下拉刷新控件
     */
     ...
     */
    public DRefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
        mContext = context;
    ...
    public View getLoadMoreFooterView() {
        ...
        if (mLoadMoreFooterView == null) {
            mLoadMoreFooterView = View.inflate(mContext, R.layout.item_normal_load_more, null);
     ...
     * @param refreshLayout
     */
    public void setRefreshLayout(DPullRefreshLayout refreshLayout) {
